        ...
        <div class="container-fluid">
            <div class="block-header">
							...
							<ol class="breadcrumb breadcrumb-col-pink">
                                <li><a href="javascript:void(0);"><i class="material-icons">person</i> <nsbp>Data Pengurus dan Kader</a></li>
                            </ol>
			...
			<!-- Basic Examples -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Data Pengurus dan Kader
                            </h2>
<?php if ($jabatan=='Administrator')
		{ ?>								
							
                            <div align="right">
								<a href="edit.php"  ><button  type="button" class="btn bg-cyan waves-effect"><i class="material-icons">add_person</i><br>Tambah Anggota</button></a>
							</div>
<?php	} ?>	 					
                        </div>
                        <div class="body">
...
?>								
								<tbody>
                                    <tr>
										...
										<td><?php echo "$amanah"; ?></td>
										<td><?php echo "$keterangan"; ?></td>
<?php if ($jabatan=='Administrator')
		{ ?>
										<td>
											<a href="edit.php?id=<?php echo "$id";?>"><button type="button" class="btn bg-blue waves-effect"><i class="material-icons">edit</i></button></a>
										</td>
										<td>
											<a href="delete.php?id=<?php echo "$id";?>"><button type="button" class="btn bg-red waves-effect"><i class="material-icons">delete</i></button></a>
										</td>
