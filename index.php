...
?>					
    ...
    <section class="content">
        <div class="container-fluid">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-indigo">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="25" data-speed="1000" data-fresh-interval="20">25</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="1843" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-orange hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="12258653" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
			...
			<!-- With Captions -->
			<div align="center">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">  <!-- galery 1-->
                    <div class="card">
                        <div class="header">
                            <h2>Rapat</h2>
                            ...
                            <div id="carousel-example-generic_2" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="item active">
                                        <img src="images/image-gallery/<?php echo "$tarbiyah_foto[1]"; ?>.jpg" />
                                        <div class="carousel-caption">
                                            <h3><?php echo "$tarbiyah_judul[1]"; ?></h3>
                                            <p><?php echo "$tarbiyah_keterangan[1]"; ?></p>
                                        </div>
                                    </div>
                                    <div class="item">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">  <!-- galery 3-->
                    <div class="card">
                        <div class="header">
                            <h2>Taklim</h2>
                            <ul class="header-dropdown m-r--5">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">  <!-- galery 4-->
                    <div class="card">
                        <div class="header">
                            <h2>Daurah</h2>
                            <ul class="header-dropdown m-r--5">
